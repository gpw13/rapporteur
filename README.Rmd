...
<!-- badges: start -->
[![R build status](https://github.com/GPW13/rapporteur/workflows/R-CMD-check/badge.svg)](https://github.com/GPW13/rapporteur/actions)
<!-- badges: end -->
...
devtools::install_github("GPW13/rapporteur")
```
